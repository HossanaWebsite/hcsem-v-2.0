...
// Large gallery with many images for events page
const images = [
    { src: '/folder/2.jpg', span: 'row-span-2' },
    { src: '/folder/3.jpg', span: 'row-span-1' },
    { src: '/folder/9.jpg', span: 'row-span-3' },
    { src: '/folder/10.jpg', span: 'row-span-1' },
    { src: '/folder/13.jpg', span: 'row-span-2' },
    { src: '/folder/16.jpg', span: 'row-span-1' },
    { src: '/folder/event-1-4.jpg', span: 'row-span-2' },
    { src: '/folder/2.jpg', span: 'row-span-1' },
    { src: '/folder/3.jpg', span: 'row-span-2' },
    { src: '/folder/9.jpg', span: 'row-span-1' },
    { src: '/folder/10.jpg', span: 'row-span-3' },
    { src: '/folder/13.jpg', span: 'row-span-1' },
    { src: '/folder/16.jpg', span: 'row-span-2' },
